...
<head>
    ...
    <title>Konfirmasi Sandi - Smart-Hub</title>
...
<body>
    ...
    <div class="auth-card">
        ...
        <h2>Konfirmasi Sandi</h2>
        <p class="subtitle">Ini adalah area aman. Harap konfirmasi kata sandi Anda sebelum melanjutkan.</p>
        ...
        <form method="POST" action="{{ route('password.confirm') }}">
            ...
            <button type="submit" class="btn btn-primary-custom w-100">KONFIRMASI</button>
        </form>
    </div>
</body>
</html>
