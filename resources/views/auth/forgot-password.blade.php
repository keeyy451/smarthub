...
<head>
    ...
    <title>Lupa Sandi - Smart-Hub</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <style>
        * { font-family: 'Outfit', sans-serif; }
        body { min-height: 100vh; display: flex; align-items: center; justify-content: center; background: #0f172a; padding: 2rem; position: relative; overflow: hidden; }
        ...
        .subtitle { color: #94a3b8; text-align: center; margin-bottom: 2rem; font-size: .9rem; line-height: 1.5; }
        ...
        .back-link { display: block; text-align: center; margin-top: 1.5rem; color: #64748b; text-decoration: none; font-size: .875rem; font-weight: 600; transition: color 0.2s; }
...
<body>
    ...
    <div class="auth-card">
        ...
        <p class="subtitle">Masukkan alamat email Anda dan kami akan mengirimkan tautan untuk mengatur ulang kata sandi Anda.</p>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <button type="submit" class="btn btn-primary-custom w-100">KIRIM TAUTAN RESET</button>
