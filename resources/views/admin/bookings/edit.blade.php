...
<div class="page-header d-flex flex-wrap justify-content-between align-items-end">
    <div>
        <h4>Edit Booking Ruangan</h4>
        <p>Perbarui detail jadwal peminjaman ruangan</p>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card content-card">
            <div class="card-header">
                <i class="bi bi-pencil-square me-2 text-primary"></i>Form Edit Booking
            </div>
            <div class="card-body p-4 p-lg-5">
                <form action="{{ route('admin.bookings.update', $booking->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="form-label">Member / Pengguna</label>
                        <input type="text" class="form-control" value="{{ $booking->user->name }} ({{ $booking->user->email }})" disabled>
                        <input type="hidden" name="user_id" value="{{ $booking->user_id }}">
                        <small class="text-muted">Member tidak dapat diubah untuk booking yang sudah ada.</small>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_ruangan" class="form-control @error('nama_ruangan') is-invalid @enderror" 
                               value="{{ old('nama_ruangan', $booking->nama_ruangan) }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" 
                                   value="{{ old('tanggal', $booking->tanggal->format('Y-m-d')) }}" required>
                    ...
                    <div class="d-flex justify-content-end gap-3 pt-4 border-top">
                        ...
                        <button type="submit" class="btn btn-primary px-4">
                            <i class="bi bi-save me-1"></i> Perbarui Booking
                        </button>
                    </div>
                </form>
            </div>
